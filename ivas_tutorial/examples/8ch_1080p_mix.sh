...
gst-launch-1.0 \
filesrc location="./videos/traffic_1080p.mp4" ! qtdemux ! h264parse ! omxh264dec internal-entropy-buffers=3 ! \
       tee name=t0 t0.src_0 ! \
       	queue ! ivas_xmultisrc kconfig="./json/kernel_xpp_pipeline.json" ! ivas_xfilter kernels-config="./json/kernel_ML_ssd.json" ! \
	...
	ivas_xfilter kernels-config="./json/kernel_swbbox_ssd.json" ! \
